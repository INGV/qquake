...
class QQuakeDialog(QDialog, FORM_CLASS):
    ...
    def __init__(self, iface, parent=None):  # pylint:disable=too-many-statements
        ...
        self.ogc_combo.addItem(self.tr('Web Map Tile Services (WMTS)'), SERVICE_MANAGER.WMTS)
    ...
    def _getEventList(self, split_strategy: Optional[str] = None):
        ...
        """
        if self.get_current_service_type() in (SERVICE_MANAGER.WMS, SERVICE_MANAGER.WMTS, SERVICE_MANAGER.WFS, SERVICE_MANAGER.WCS):
